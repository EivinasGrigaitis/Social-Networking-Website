...
$navBarActive = "admin";
$getAllUsers = $getUserAdmin->getAllUsers($user_id);
...
//        " |user Role - ".$userRole ."| Warning - ". $userWarning;
    ...
    if ($getUserAdmin->editUser($userId, $userName, $userEmail, $userRole, $userWarning) or $getUserAdmin->checkPassword($userId, $userPasswd)) {

        $getFromUser->phpAlertMessage('Naudotojo informacija paredaguota ');

        echo "<script>setTimeout(\"location.href = 'admin.php';\",500);</script>";
    }
