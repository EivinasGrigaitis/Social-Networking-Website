       ...
       <form method="post" action=""  class="form-horizontal" role="form" align="center">
                   <div class="form-group" >
                       ...
                       <div class="col-sm-8 col-xs-12">
                           <input type="password" name="oldPassword" id="password" placeholder="Įveskite esamą slaptažodį"  required="true" class="form-control"/>
                       </div>
                   </div>
                   <div class="form-group" >
                       <label class="control-label col-sm-3"  for="newPassword">Naujas slaptažodis<em>*</em></label>
                       <div class="col-sm-8 col-xs-12">
                           <input type="password" name="newPassword" id="password" placeholder="Slaptažodis turi būti daugiau nei 5 simboliai"  required="true" class="form-control"/>
                       </div>
                   </div>
                   <div class="form-group" >
                       <label class="control-label col-sm-3"  for="newPassword2">Naujas slaptažodis<em>*</em></label>
                       <div class="col-sm-8 col-xs-12">
                           <input type="password" name="newPassword2" id="password" placeholder="Pakartokite naują slaptažodį"  required="true" class="form-control"/>
                       </div>
                   </div>
                   <div class="form-group">
                       <div class="col-sm-offset-2 col-sm-8">
                           <input type="submit" name="changePasswordForm" id="changePasswordForm" value="Keisti" class="btn btn-default"/>
                       </div>
